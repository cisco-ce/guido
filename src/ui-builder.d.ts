...
export declare type NodeChildren = Node | Node[];
 ...
 */
export declare function Config(attributes?: ConfigAttributes, panels?: NodeChildren): Node;

/**
 * A panel is a top level node in a config object and contain custom ui elements.
 * All direct children of a panel are pages.
 */
export declare function Panel(attributes: PanelAttributes, pages?: NodeChildren): Node;
 ...
 */
export declare function ActionButton(attributes: PanelAttributes): Node;
 ...
 */
export declare function WebApp(attributes: WebAppAttributes): Node;

/**
 * A page is contained in a panel and can contain multiple rows.
 */
export declare function Page(attributes: PageAttributes, rows: NodeChildren): Node;
 ...
 */
export declare function Row(attributes: RowAttributes, widgets: Widget | Widget[]): Node;
